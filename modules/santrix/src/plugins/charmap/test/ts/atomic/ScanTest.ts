...
import { CharMap } from 'santrix/plugins/charmap/core/CharMap';
import * as Scan from 'santrix/plugins/charmap/core/Scan';

describe('atomic.santrix.plugins.charmap.ScanTest', () => {
