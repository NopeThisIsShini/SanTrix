...
import { TableEventData } from 'santrix/core/api/EventTypes';
import * as FakeClipboard from 'santrix/plugins/table/api/Clipboard';
import TablePlugin from 'santrix/plugins/table/Plugin';

import * as TableTestUtils from '../module/test/TableTestUtils';

describe('browser.santrix.plugins.table.ClipboardTest', () => {
  ...
  it('TINY-8568: should correctly copy and paste colgroup table with complex selection', () => {
    ...
    assert.equal(dataTransfer.getData('text/html'), '<!-- x-santrix/html -->' + expectedTable);
