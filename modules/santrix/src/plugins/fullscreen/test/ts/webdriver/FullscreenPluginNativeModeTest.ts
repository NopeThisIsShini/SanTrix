...
import { getFullscreenElement } from 'santrix/plugins/fullscreen/core/NativeFullscreen';
import Plugin from 'santrix/plugins/fullscreen/Plugin';

describe('webdriver.santrix.plugins.fullscreen.FullScreenPluginNativeModeTest', () => {
  before(function () {
