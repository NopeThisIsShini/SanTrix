...
import { DialogChanges, DialogDelta } from 'santrix/plugins/link/ui/DialogChanges';
import { LinkDialogCatalog, LinkDialogData, ListItem } from 'santrix/plugins/link/ui/DialogTypes';

const tOptional = OptionalInstances.tOptional;

describe('browser.santrix.plugins.link.DialogChangesTest', () => {
  context('getDelta', () => {
