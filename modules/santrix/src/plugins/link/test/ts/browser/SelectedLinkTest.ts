...
describe('browser.santrix.plugins.link.SelectedLinkTest', () => {
  ...
  it('TBA: should not get anchor info if not selected node', async () => {
    ...
    editor.setContent('<p><a href="http://santrix.com">tiny</a></p>');
  ...
  it('TINY-4867: link should not be active when multiple links or plain text selected', async () => {
    const editor = hook.editor();
    editor.setContent('<p><a href="http://santrix.com">a</a> b <a href="http://santrix.com">c</a></p>');
