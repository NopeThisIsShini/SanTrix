...
import Env from 'santrix/core/api/Env';
import Plugin from 'santrix/plugins/template/Plugin';
import { getPreviewContent } from 'santrix/plugins/template/ui/Dialog';
...
const noCorsNoStyle = '<!DOCTYPE html><html><head>' +
  `<base href="http://${host}/">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/santrix/js/santrix/skins/ui/oxide/content.min.css">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/santrix/js/santrix/skins/content/default/content.css">` +
...
const corsNoStyle = '<!DOCTYPE html><html><head>' +
  `<base href="http://${host}/">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/santrix/js/santrix/skins/ui/oxide/content.min.css" crossorigin="anonymous">` +
  `<link type="text/css" rel="stylesheet" href="http://${host}/project/santrix/js/santrix/skins/content/default/content.css" crossorigin="anonymous">` +
  '<script>document.addEventListener && document.addEventListener("click", function(e) {for (var elm = e.target; elm; elm = elm.parentNode) {if (elm.nodeName === "A" && !(' +
  metaKey +
...
describe.skip('browser.santrix.plugins.template.Dialog.getPreviewContent', () => {
