...
import { StyleMap } from 'santrix/core/api/html/Styles';
import { Dialog as DialogType } from 'santrix/core/api/ui/Ui';
import ImageUploader, { UploadResult } from 'santrix/core/api/util/ImageUploader';
