...
import AutoresizePlugin from 'santrix/plugins/autoresize/Plugin';
import FullscreenPlugin from 'santrix/plugins/fullscreen/Plugin';

describe('browser.santrix.plugins.autoresize.AutoresizePluginTest', () => {
  ...
  context('common tests', () => {
    ...
    it('TBA: Editor size increase with async loaded content', async () => {
      ...
      editor.dom.setAttrib(image, 'src', 'http://moxiecode.cachefly.net/santrix/v9/images/logo.png');
