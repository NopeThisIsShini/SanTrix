...
import { parseStartValue, parseDetail, ListDetail } from 'santrix/plugins/lists/core/ListNumbering';

describe('atomic.santrix.plugins.lists.core.ListNumberingTest', () => {
