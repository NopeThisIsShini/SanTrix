...
import { ExecCommandEvent } from 'santrix/core/api/EventTypes';
import { EditorEvent } from 'santrix/core/api/util/EventDispatcher';
import Plugin from 'santrix/plugins/lists/Plugin';

describe('browser.santrix.plugins.lists.ListPropertiesTest', () => {
  ...
  const contentMenuSelector = '.tox-santrix-aux .tox-menu .tox-collection__item:contains("List properties...")';
