...
describe('browser.santrix.plugins.emoticons.EmoticonAutocompletionTest', () => {
  const hook = TinyHooks.bddSetupLight<Editor>({
    plugins: 'emoticons',
    toolbar: 'emoticons',
    base_url: '/project/santrix/js/santrix',
    emoticons_database_url: '/project/santrix/src/plugins/emoticons/test/js/test-emojis.js',
    emoticons_database_id: 'santrix.plugins.emoticons.test-emojis.js'
  }, [ Plugin ], true);
