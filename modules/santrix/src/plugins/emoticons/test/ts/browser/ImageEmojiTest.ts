...
describe.skip('browser.santrix.plugins.emoticons.ImageEmojiTest', () => {
  const hook = TinyHooks.bddSetupLight<Editor>({
    plugins: 'emoticons',
    toolbar: 'emoticons',
    base_url: '/project/santrix/js/santrix',
    emoticons_database_url: '/project/santrix/src/plugins/emoticons/main/js/emojiimages.js',
    setup: () => {
      Resource.unload('santrix.plugins.emoticons');
    }
  }, [ Plugin ], true);
