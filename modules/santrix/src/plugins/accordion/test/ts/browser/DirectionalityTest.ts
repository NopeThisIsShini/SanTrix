...
import AccordionPlugin from 'santrix/plugins/accordion/Plugin';
import DirectionalityPlugin from 'santrix/plugins/directionality/Plugin';

describe('browser.santrix.plugins.accordion.DirectionalityTest', () => {
