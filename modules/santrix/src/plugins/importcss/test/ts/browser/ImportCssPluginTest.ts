...
import Plugin from 'santrix/plugins/importcss/Plugin';
...
describe('browser.santrix.plugins.importcss.ImportCssTest', () => {
  before(() => {
    Plugin();
  });
  ...
  it('TBA: content_css with one file, append default', () => pTestEditorWithSettings(
    ...
    {
      content_css: [ '/project/santrix/src/plugins/importcss/test/css/basic.css' ],
  ...
  it('TBA: content_css with multiple files, append true', () => pTestEditorWithSettings(
    ...
    {
      content_css: [
        '/project/santrix/src/plugins/importcss/test/css/basic.css',
        '/project/santrix/src/plugins/importcss/test/css/advanced.css',
        '/project/santrix/src/plugins/importcss/test/css/other-adv.css'
      ],
      importcss_append: true
    }
  ));
  ...
  it('TINY-8238: content_css with two files, basic and internal CSS classes', () => pTestEditorWithSettings(
    ...
    },
    {
      content_css: [
        '/project/santrix/src/plugins/importcss/test/css/basic.css',
        '/project/santrix/src/plugins/importcss/test/css/internal.css'
      ],
      importcss_append: undefined
    }
  ));
