...
import { getDimensions, ResizeTypes } from 'santrix/themes/silver/ui/sizing/Resize';
import * as Utils from 'santrix/themes/silver/ui/sizing/Utils';
...
describe('atomic.santrix.themes.silver.sizing.ResizeTest', () => {
