...
import { formatSize } from 'santrix/themes/silver/ui/sizeinput/SizeInputModel';

describe('atomic.santrix.themes.silver.components.sizeinput.SizeInputFormatTest', () => {
