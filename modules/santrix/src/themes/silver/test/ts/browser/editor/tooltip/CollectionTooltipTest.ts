...
import CharmapPlugin from 'santrix/plugins/charmap/Plugin';
import EmoticonsPlugin from 'santrix/plugins/emoticons/Plugin';

import * as TooltipUtils from '../../../module/TooltipUtils';

describe('browser.santrix.themes.silver.editor.CollectionTooltipTest', () => {
