...
describe.skip('browser.santrix.themes.silver.editor.contexttoolbar.RemoveContextToolbarOnFocusoutTest', () => {
  ...
  it('iframe editor focusout should remove context toolbar', async () => {
    const editor = await McEditor.pFromHtml<Editor>(html, { setup, base_url: '/project/santrix/js/santrix' });
    editor.focus();
  ...
  it('inline editor focusout should remove context toolbar', async () => {
    const editor = await McEditor.pFromHtml<Editor>(html, { setup, inline: true, base_url: '/project/santrix/js/santrix' });
    editor.focus();
