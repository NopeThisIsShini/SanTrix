...
import * as Options from 'santrix/themes/silver/ui/menus/contextmenu/Options';

describe('browser.santrix.themes.silver.editor.contextmenu.ContextMenuSettingsTest', () => {
