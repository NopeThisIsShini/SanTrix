...
import * as Backstage from 'santrix/themes/silver/backstage/Backstage';
import * as Options from 'santrix/themes/silver/ui/core/color/Options';

describe('browser.santrix.themes.silver.editor.backstage.BackstageSinkTest', () => {
