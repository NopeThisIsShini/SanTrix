...
import SavePlugin from 'santrix/plugins/save/Plugin';
import SearchReplacePlugin from 'santrix/plugins/searchreplace/Plugin';

import * as TooltipUtils from '../../../module/TooltipUtils';

describe('browser.santrix.themes.silver.editor.TooltipShortcutTest', () => {
