...
import { WindowManagerImpl } from 'santrix/core/api/WindowManager';
import * as WindowManager from 'santrix/themes/silver/ui/dialog/WindowManager';

import * as TestExtras from '../../module/TestExtras';

describe('headless.santrix.themes.silver.window.SilverUrlDialogTest', () => {
  ...
  const openDialog = () => {
    dialogApi = windowManager.openUrl({
      ...
      url: '/project/santrix/src/themes/silver/test/html/iframe.html',
      buttons: [
        {
          type: 'custom',
          name: 'barny',
