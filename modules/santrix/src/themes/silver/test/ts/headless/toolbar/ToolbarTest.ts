...
import { renderToolbar, renderToolbarGroup } from 'santrix/themes/silver/ui/toolbar/CommonToolbar';

import TestProviders from '../../module/TestProviders';

describe('headless.santrix.themes.silver.toolbar.ToolbarTest', () => {
