...
import { UiFactoryBackstage, UiFactoryBackstageProviders } from 'santrix/themes/silver/backstage/Backstage';
import { renderDialog } from 'santrix/themes/silver/ui/window/SilverDialog';

describe('headless.santrix.themes.silver.window.SilverDialogEventTest', () => {
