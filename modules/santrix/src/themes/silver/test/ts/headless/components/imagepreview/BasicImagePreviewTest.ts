...
import { ImagePreviewDataSpec, renderImagePreview } from 'santrix/themes/silver/ui/dialog/ImagePreview';

describe('headless.santrix.themes.silver.components.imagepreview.BasicImagePreviewTest', () => {
