...
import { renderFooterButton } from 'santrix/themes/silver/ui/general/Button';

import TestBackstage from '../../../module/TestBackstage';

describe('headless.santrix.themes.silver.components.dialogbutton.DialogFooterButtonTest', () => {
