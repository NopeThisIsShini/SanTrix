...
import { SimpleBehaviours } from 'santrix/themes/silver/ui/alien/SimpleBehaviours';
import { onControlAttached, onControlDetached } from 'santrix/themes/silver/ui/controls/Controls';

describe('headless.santrix.themes.silver.configs.ControlOnSetup Test', () => {
