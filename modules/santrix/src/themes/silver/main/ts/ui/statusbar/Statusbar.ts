      ...
      components: [
        {
          dom: {
            tag: 'a',
            attributes: {
              href: 'https://santrix.org/powered-by-santrix?utm_campaign=poweredby&utm_source=editor&utm_medium=referral&utm_content=v1',
              rel: 'noopener',
              target: '_blank',
            },
            innerHtml: I18n.translate([ 'Powered by {0}', 'SanTrix' ]),
          },
