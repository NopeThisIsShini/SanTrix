...
describe('browser.santrix.core.EditorManagerTest', () => {
  ...
  it('get', (done) => {
    viewBlock.update('<textarea class="santrix"></textarea>');
    EditorManager.init({
    ...
    EditorManager.init({
      ...
      init_instance_callback: (editor1) => {
        setTimeout(() => {
          ...
          EditorManager.init({
            selector: 'textarea',
            skin_url: '/project/santrix/js/santrix/skins/ui/oxide',
            content_css: '/project/santrix/js/santrix/skins/content/default',
