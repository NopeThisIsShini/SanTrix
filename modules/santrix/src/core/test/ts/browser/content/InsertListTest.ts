...
import DomParser from 'santrix/core/api/html/DomParser';
import AstNode from 'santrix/core/api/html/Node';
import Schema from 'santrix/core/api/html/Schema';
import * as InsertList from 'santrix/core/content/InsertList';

describe('browser.santrix.core.content.InsertListTest', () => {
  const schema = Schema({});
