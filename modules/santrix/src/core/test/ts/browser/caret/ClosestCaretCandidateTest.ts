...
import { FakeCaretPosition, closestCaretCandidateNodeRect, closestFakeCaretCandidate } from 'santrix/core/caret/ClosestCaretCandidate';
...
describe('browser.santrix.core.ClosestCaretCandidateTest', () => {
