...
import { FakeCaret, isFakeCaretTarget } from 'santrix/core/caret/FakeCaret';
import { isFakeCaretTableBrowser } from 'santrix/core/keyboard/TableNavigation';
import * as Zwsp from 'santrix/core/text/Zwsp';

import * as CaretAsserts from '../../module/test/CaretAsserts';
import * as ViewBlock from '../../module/test/ViewBlock';

describe('browser.santrix.core.caret.FakeCaretTest', () => {
