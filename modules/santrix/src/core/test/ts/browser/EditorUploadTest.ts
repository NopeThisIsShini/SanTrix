...
import { UploadResult } from 'santrix/core/api/EditorUpload';
import Env from 'santrix/core/api/Env';
import { BlobInfo } from 'santrix/core/api/file/BlobCache';
...
describe('browser.santrix.core.EditorUploadTest', () => {
