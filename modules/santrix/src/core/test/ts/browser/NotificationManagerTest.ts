...
import { BeforeOpenNotificationEvent, OpenNotificationEvent } from 'santrix/core/api/EventTypes';
import { NotificationSpec } from 'santrix/core/api/NotificationManager';

describe('browser.santrix.core.NotificationManagerTest', () => {
  Arr.each([
