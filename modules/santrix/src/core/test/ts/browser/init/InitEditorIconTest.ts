...
import IconManager from 'santrix/core/api/IconManager';

describe('browser.santrix.core.init.InitEditorIconTest', () => {
  const overrideIcon = '<svg>override-icon</svg>';
  const hook = TinyHooks.bddSetupLight<Editor>({
    icons: 'custom',
    icons_url: '/project/santrix/src/core/test/assets/icons/custom/icons.js',
