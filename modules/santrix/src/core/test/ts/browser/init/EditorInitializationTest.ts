...
describe('browser.santrix.core.init.EditorInitializationTest', () => {
  ...
  const pCreateInlineModeMultipleInstances = (): Promise<Editor[]> => {
    viewBlock.update('<div class="santrix-editor"><p>a</p></div><div class="santrix-editor"><p>b</p></div>');
  ...
  const assertEditors = (editors: Editor[]) => {
    ...
    const containerApproxStructure = ApproxStructure.build((s, str, arr) => s.element('div', {
      classes: [ arr.has('tox'), arr.has('tox-santrix'), arr.has('tox-santrix-inline') ],
      children: [
        s.element('div', {
