...
import * as InlinePattern from 'santrix/core/textpatterns/core/InlinePattern';
import {
  DynamicPatternContext, InlinePattern as InlinePatternType, InlinePatternMatch, PatternSet
} from 'santrix/core/textpatterns/core/PatternTypes';
import { PathRange } from 'santrix/core/textpatterns/utils/PathRange';
import { getBeforeText, getParentBlock, resolveFromDynamicPatterns } from 'santrix/core/textpatterns/utils/Utils';
import ListsPlugin from 'santrix/plugins/lists/Plugin';

import { getPatternSetFor } from '../../module/test/TextPatternsUtils';

describe('browser.santrix.textpatterns.FindInlinePatternTest', () => {
