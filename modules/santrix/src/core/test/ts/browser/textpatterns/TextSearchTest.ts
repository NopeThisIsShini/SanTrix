...
import { SpotPoint } from 'santrix/core/alien/Spot';
import * as TextSearch from 'santrix/core/alien/TextSearch';
import Editor from 'santrix/core/api/Editor';

describe('browser.santrix.core.textpatterns.TextSearchTest', () => {
