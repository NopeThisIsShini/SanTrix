...
import FocusManager from 'santrix/core/api/FocusManager';
import * as FocusController from 'santrix/core/focus/FocusController';

describe('browser.santrix.core.focus.FocusControllerTest', () => {
  Arr.each([
