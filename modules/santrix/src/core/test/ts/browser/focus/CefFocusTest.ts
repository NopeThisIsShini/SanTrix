...
describe('browser.santrix.core.focus.CefFocusTest', () => {
  ...
  it('Focus editors', async () => {
    const editor1 = await pCreateInlineEditor('<div class="santrix"><p contenteditable="false">a</p></div>');
    const editor2 = await pCreateInlineEditor('<div class="santrix"><p contenteditable="false">b</p></div>');
