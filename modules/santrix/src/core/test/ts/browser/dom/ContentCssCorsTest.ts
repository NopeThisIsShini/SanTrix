...
describe('browser.santrix.core.dom.ContentCssCorsTest', () => {
  const settings = {
  ...
  context('Classic mode: Editor StyleSheetLoader is separate from global (santrix)', () => {
  ...
  context('Inline mode: Global (santrix) StyleSheetLoader is shared amongst multiple inline editors', () => {
  ...
  context('Classic and inline editors: Global (santrix) StyleSheetLoader is shared amongst multiple inline editors, but classic editor has separate stylesheetloader', () => {
