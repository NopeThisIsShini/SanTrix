...
import Schema from 'santrix/core/api/html/Schema';
import Tools from 'santrix/core/api/util/Tools';

import * as HtmlUtils from '../../module/test/HtmlUtils';

describe('browser.santrix.core.dom.DOMUtilsTest', () => {
  ...
  it('loadCSS', () => {
    ...
    DOM.loadCSS('santrix/dom/test.css?a=1,santrix/dom/test.css?a=2,santrix/dom/test.css?a=3');
  ...
  it('loadCSS contentCssCors enabled', () => {
    ...
    CustomDOM.loadCSS('santrix/dom/test_cors.css?a=1,santrix/dom/test_cors.css?a=2,santrix/dom/test_cors.css?a=3');
  ...
  it('isEmpty', () => {
    ...
    DOM.setHTML('test', '<img src="santrix/ui/img/raster.gif">');
    assert.isFalse(DOM.isEmpty(getTestElement()));
