...
describe('browser.santrix.core.dom.StyleSheetLoaderTest', () => {
  const contentCss = '/project/santrix/js/santrix/skins/content/default/content.css';
  const skinCss = '/project/santrix/js/santrix/skins/ui/oxide/skin.css';
