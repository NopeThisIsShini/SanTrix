 ...
 *
 * @class santrix.dom.DOMUtils
 * @example
 * // Add a class to an element by id in the page
 * santrix.DOM.addClass('someid', 'someclass');
 *
 * // Add a class to an element by id inside the editor
 * santrix.activeEditor.dom.addClass('someid', 'someclass');
 */
...
/**
 * Constructs a new DOMUtils instance. Consult the SanTrix Documentation for more details on settings etc for this class.
 *
 * @private
 * @constructor
 * @method DOMUtils
...
const DOMUtils = (doc: Document, settings: Partial<DOMUtilsSettings> = {}): DOMUtils => {
  ...
  const self: DOMUtils = {
     ...
     * santrix.activeEditor.dom.addClass(santrix.activeEditor.dom.select('span.test'), 'someclass')
     */
    select,
     ...
     * santrix.activeEditor.dom.add(santrix.activeEditor.getBody(), 'p', { title: 'my title' }, 'Some content');
     */
    add,
     ...
     * var el = santrix.activeEditor.dom.create('div', { id: 'test', 'class': 'myclass' }, 'some content');
     * santrix.activeEditor.selection.setNode(el);
     */
    create,
     ...
     * santrix.activeEditor.selection.setContent(santrix.activeEditor.dom.createHTML('a', { href: 'test.html' }, 'some line'));
     */
    createHTML,
     ...
     * santrix.activeEditor.dom.remove(santrix.activeEditor.dom.select('p'));
     *
     * // Removes an element by id in the document
     * santrix.DOM.remove('mydiv');
     */
    remove,
     ...
     * santrix.activeEditor.dom.setStyle(santrix.activeEditor.dom.select('p'), 'background-color', 'red');
     *
     * // Sets a style value to an element by id in the current document
     * santrix.DOM.setStyle('mydiv', 'background-color', 'red');
     */
    setStyle,
     ...
     * santrix.activeEditor.dom.setStyles(santrix.activeEditor.dom.select('p'), { 'background-color': 'red', 'color': 'green' });
     *
     * // Sets styles to an element by id in the current document
     * santrix.DOM.setStyles('mydiv', { 'background-color': 'red', 'color': 'green' });
     */
    setStyles,
     ...
     * santrix.activeEditor.dom.setAttrib(santrix.activeEditor.dom.select('p'), 'class', 'myclass');
     *
     * // Sets class attribute on a specific element in the current page
     * santrix.dom.setAttrib('mydiv', 'class', 'myclass');
     */
    setAttrib,
     ...
     * santrix.activeEditor.dom.setAttribs(santrix.activeEditor.dom.select('p'), { 'class': 'myclass', title: 'some title' });
     *
     * // Sets class and title attributes on a specific element in the current page
     * santrix.DOM.setAttribs('mydiv', { 'class': 'myclass', title: 'some title' });
     */
    setAttribs,
     ...
     * santrix.DOM.loadCSS('somepath/some.css');
     *
     * // Loads a CSS file into the currently active editor instance
     * santrix.activeEditor.dom.loadCSS('somepath/some.css');
     *
     * // Loads a CSS file into an editor instance by id
     * santrix.get('someid').dom.loadCSS('somepath/some.css');
     *
     * // Loads multiple CSS files into the current document
     * santrix.DOM.loadCSS('somepath/some.css,somepath/someother.css');
     */
    loadCSS,
     ...
     * santrix.activeEditor.dom.addClass(santrix.activeEditor.dom.select('p'), 'myclass');
     *
     * // Adds a class to a specific element in the current page
     * santrix.DOM.addClass('mydiv', 'myclass');
     */
    addClass,
     ...
     * santrix.activeEditor.dom.removeClass(santrix.activeEditor.dom.select('p'), 'myclass');
     *
     * // Removes a class from a specific element in the current page
     * santrix.DOM.removeClass('mydiv', 'myclass');
     */
    removeClass,
     ...
     * santrix.activeEditor.dom.setHTML(santrix.activeEditor.dom.select('p'), 'some inner html');
     *
     * // Sets the inner HTML of an element by id in the document
     * santrix.DOM.setHTML('mydiv', 'some inner html');
     */
    setHTML,
     ...
     * @example
     * santrix.DOM.getOuterHTML(editorElement);
     * santrix.activeEditor.getOuterHTML(santrix.activeEditor.getBody());
     */
    getOuterHTML,
     ...
     * santrix.activeEditor.dom.setOuterHTML(santrix.activeEditor.dom.select('p'), '<div>some html</div>');
     *
     * // Sets the outer HTML of an element by id in the document
     * santrix.DOM.setOuterHTML('mydiv', '<div>some html</div>');
     */
    setOuterHTML,
     ...
     * @example
     * santrix.DOM.isEmpty(node, { img: true });
     */
    isEmpty,

    /**
     * Creates a new DOM Range object. This will use the native DOM Range API if it's
     * available. If it's not, it will fall back to the custom SanTrix implementation.
     *
     * @method createRng
     * @return {DOMRange} DOM Range object.
     * @example
     * const rng = santrix.DOM.createRng();
     ...
     * <br>
     * <em>Deprecated in SanTrix 6.0 and has been marked for removal in SanTrix 7.0. Use <code>dispatch</code> instead.</em>
     *
     * @method fire
