...
/**
 * This class is used to serialize DOM trees into a string. Consult the SanTrix API Documentation for
 * more details and examples on how to use this class.
 *
 * @class santrix.dom.Serializer
 */
...
const DomSerializer = (settings: DomSerializerSettings, editor?: Editor): DomSerializer => {
  ...
  return {
     ...
     *
     * @field {santrix.html.Schema} schema
     */
     ...
     * Consult the SanTrix Documentation for more details on this format.
     *
     * @method addRules
