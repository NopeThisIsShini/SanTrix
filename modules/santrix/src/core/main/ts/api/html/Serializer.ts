 ...
 *
 * @class santrix.html.Serializer
 * @version 3.4
 * @example
 * santrix.html.Serializer().serialize(santrix.html.DomParser().parse('<p>text</p>'));
 */
...
const HtmlSerializer = (settings: HtmlSerializerSettings = {}, schema: Schema = Schema()): HtmlSerializer => {
   ...
   *
   * @method serialize
   * @param {santrix.html.Node} node Node instance to serialize.
