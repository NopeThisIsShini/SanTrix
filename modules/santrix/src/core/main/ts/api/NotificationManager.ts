...
/**
 * This class handles the creation of SanTrix's notifications.
 *
 * @class santrix.NotificationManager
 * @example
...
const NotificationManager = (editor: Editor): NotificationManager => {
  ...
  return {
     ...
     * <br /><br />
     * For information on the available settings, see: <a href="https://www.santrix.org/docs/santrix/1/creating-custom-notifications/">Create custom notifications</a>.
     */
    open,
