...
/**
 * This class contains the core logic for a SanTrix editor.
 *
 * @class santrix.Editor
 * @mixes santrix.util.Observable
 * @example
 * // Add a class to all paragraphs in the editor.
 * santrix.activeEditor.dom.addClass(santrix.activeEditor.dom.select('p'), 'someclass');
 *
 * // Gets the current editors selection as text
 * santrix.activeEditor.selection.getContent({ format: 'text' });
 *
 * // Creates a new editor instance
 * const ed = new santrix.Editor('textareaid', {
 *   some_setting: 1
 * }, santrix.EditorManager);
 *
 * ed.render();
 */
 ...
 *
 * @include ../../../../../tools/docs/santrix.Editor.js
 */
...
class Editor implements EditorObservable {
   ...
   * santrix.activeEditor.plugins.someplugin.someMethod();
   */
  public plugins: Record<string, Plugin> = {};

  /**
   * URI object to document configured for the SanTrix instance.
   *
   * @property documentBaseURI
   * @type santrix.util.URI
   * @example
   * // Get relative URL from the location of document_base_url
   * santrix.activeEditor.documentBaseURI.toRelative('/somedir/somefile.htm');
   *
   * // Get absolute URL from the location of document_base_url
   * santrix.activeEditor.documentBaseURI.toAbsolute('somefile.htm');
   */
  public documentBaseURI: URI;

  /**
   * URI object to current document that holds the SanTrix editor instance.
   *
   * @property baseURI
   * @type santrix.util.URI
   * @example
   * // Get relative URL from the location of the API
   * santrix.activeEditor.baseURI.toRelative('/somedir/somefile.htm');
   *
   * // Get absolute URL from the location of the API
   * santrix.activeEditor.baseURI.toAbsolute('somefile.htm');
   */
  public baseURI: URI;
   ...
   * @param {santrix.EditorManager} editorManager EditorManager instance.
   */
  ...
  /**
   * Focuses/activates the editor. This will set this editor as the activeEditor in the santrix collection
   ...
   * <br>
   * <em>Deprecated in SanTrix 6.0 and has been marked for removal in SanTrix 7.0. Use the <code>editor.options.get</code> API instead.</em>
   *
   * @method getParam
   ...
   * const someval = santrix.activeEditor.getParam('myvalue');
   *
   * // Returns a specific config value from a specific editor instance by id
   * const someval2 = santrix.get('my_editor').getParam('myvalue');
   */
   ...
   *
   * @method hasPlugin
   * @param {String} name The name of the plugin, as specified for the SanTrix `plugins` option.
   ...
   * the santrix command identifiers documentation.
   *
   * @method execCommand
   ...
   * santrix.activeEditor.setProgressState(true);
   *
   * // Hide progress for the active editor
   * santrix.activeEditor.setProgressState(false);
   *
   * // Show progress after 3 seconds
   * santrix.activeEditor.setProgressState(true, 3000);
   */
   ...
   * <br>
   * <em>Note: The content return value was deprecated in SanTrix 6.0 and has been marked for removal in SanTrix 7.0.</em>
   *
   * @method setContent
   ...
   * santrix.activeEditor.setContent('<span>some</span> html');
   *
   * // Sets the content of a specific editor (my_editor in this example)
   * santrix.get('my_editor').setContent(data);
   *
   * // Sets the content of the activeEditor editor using the specified format
   * santrix.activeEditor.setContent('<p>Some html</p>', { format: 'html' });
   */
   ...
   * console.debug(santrix.activeEditor.getContent());
   *
   * // Get the contents of the currently active editor as plain text
   * santrix.activeEditor.getContent({ format: 'text' });
   *
   * // Get content of a specific editor:
   * santrix.get('content id').getContent()
   */
   ...
   * @example
   * if (santrix.activeEditor.isDirty()) {
  ...
  /**
   * Returns the target element/textarea that got replaced with a SanTrix editor instance.
   *
   * @method getElement
  ...
  /**
   * Removes the editor from the dom and santrix collection.
   *
   * @method remove
   */
  public remove(): void {
