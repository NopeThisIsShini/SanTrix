 ...
 * directly on the santrix namespace.
 *
 * @class santrix.util.Tools
 */
 ...
 * const obj = santrix.resolve('a.b.c.d');
 */
 ...
 * const arr = santrix.explode('a, b,   c');
 */
...
const Tools: Tools = {
   ...
   * @example
   * // Iterate an array
   * santrix.each([ 1,2,3 ], (v, i) => {
   *   console.debug("Value: " + v + ", Index: " + i);
   * });
   *
   * // Iterate an object
   * santrix.each({ a: 1, b: 2, c: 3 }, (v, k) => {
   ...
   * const items = santrix.grep([ 1,2,3,4,5 ], (v) => v > 3);
   */
