...
/**
 * SanTrix Editor Upload API
 * Handles image uploads, updates undo stack and patches over various internal functions.
 *
 * @class santrix.EditorUpload
 * @example
 * // Apply a new filter within the image scan.
 * santrix.activeEditor.EditorUpload.addFilter((image) => {
 ...
 * santrix.activeEditor.EditorUpload.uploadImages();
 *
 * // Scan the editor for valid images
 * santrix.activeEditor.EditorUpload.scanForImages();
 */
