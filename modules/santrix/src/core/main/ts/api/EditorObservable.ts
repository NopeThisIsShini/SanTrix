...
/**
 * This mixin contains the event logic for the santrix.Editor class.
 *
 * @mixin santrix.EditorObservable
 * @extends santrix.util.Observable
 * @private
 */
 ...
 *
 * @private
 * @param {santrix.Editor} editor Editor instance to get event target from.
