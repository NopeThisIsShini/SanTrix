...
/**
 * SanTrix theme pseudo class. Allows for a custom theme to be used with SanTrix when registered using the ThemeManager.
 *
 * @summary This is a pseudo class that describes how to create a custom theme for SanTrix.
 * <br><br>
 * See AddOnManager for more information about the methods available on the ThemeManager instance.
 * <br><br>
 * <strong>Warning</strong>: Much of SanTrix's functionality is provided by the default Silver theme.
 * Creating a custom theme may require the re-implementation of this functionality.
 * To change SanTrix's appearance, we recommend changing the Skin instead.
 *
 * @class santrix.Theme
 * @example
 * santrix.ThemeManager.add('MyTheme', (editor) => {
...
/**
 * SanTrix plugin psuedo class. Allows for custom plugins to be added to SanTrix when registered using the PluginManager.
 *
 * @summary This is a pseudo class that describes how to create a custom plugin for SanTrix.
 * <br><br>
 ...
 *
 * @class santrix.Plugin
 * @example
 * santrix.PluginManager.add('MyPlugin', (editor, url) => {
...
const AddOnManager = <T>(): AddOnManager<T> => {
  ...
  return {
     ...
     * @return {santrix.Theme/santrix.Plugin} Theme or plugin add-on instance or undefined.
     */
    get,
     ...
     * @param {santrix.Theme/santrix.Plugin} addOn Theme or plugin to add.
     * @return {santrix.Theme/santrix.Plugin} The same theme or plugin instance that got passed in.
     * @example
     ...
     * santrix.PluginManager.add('test', TestPlugin);
     *
     * // Initialize SanTrix
     * santrix.init({
     *   ...
     ...
     * santrix.PluginManager.load('myplugin', '/some/dir/someplugin/plugin.js');
     *
     * // Initialize SanTrix
     * santrix.init({
     *   ...
