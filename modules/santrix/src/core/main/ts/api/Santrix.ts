...
interface SanTrix extends EditorManager {
...
/**
 * @include ../../../../../tools/docs/santrix.js
 */

/**
 * @include ../../../../../tools/docs/santrix.Event.js
 */

/**
 * @include ../../../../../tools/docs/santrix.editor.ui.Ui.js
 */
...
const santrix: SanTrix = Tools.extend(EditorManager, publicApi);
