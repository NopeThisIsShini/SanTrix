 ...
 * @private
 * @static
 * @class santrix.caret.CaretBookmark
 * @example
...
export {
   ...
   * @param {santrix.caret.CaretPosition} caretPosition Caret position within the root node.
   ...
   * @return {santrix.caret.CaretPosition} Caret position resolved from xpath like bookmark.
   */
  resolve
};
