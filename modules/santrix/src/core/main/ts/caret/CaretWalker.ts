 ...
 *
 * @private
 * @class santrix.caret.CaretWalker
 * @example
...
export const CaretWalker = (root: Node): CaretWalker => ({
  /**
     ...
     *
     * @method next
     * @param {santrix.caret.CaretPosition} caretPosition Caret position to start from.
     * @return {santrix.caret.CaretPosition} CaretPosition or null if no position was found.
     */
  next: (caretPosition: CaretPosition | null): CaretPosition | null => {
