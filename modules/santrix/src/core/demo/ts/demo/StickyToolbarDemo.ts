...
import { Editor, RawEditorOptions, SanTrix } from 'santrix/core/api/PublicApi';
...
export default (): void => {
  ...
  santrix.init(stickySettings);
  santrix.init({ ...stickySettings, inline: true, selector: '.santrix' });
};
