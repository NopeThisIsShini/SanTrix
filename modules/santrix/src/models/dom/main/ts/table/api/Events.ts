...
import { NewTableCellEvent, NewTableRowEvent, TableEventData } from 'santrix/core/api/EventTypes';
import { EditorEvent } from 'santrix/core/api/util/EventDispatcher';

// Duplicated in modules/santrix/src/themes/silver/main/ts/ui/selector/TableSelectorHandles.ts
