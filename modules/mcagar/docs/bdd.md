...
- `bddSetup(settings: RawEditorSettings, setupModules?: Array<() => void>, focusOnInit?: boolean)`
  - Sets up the editor using the settings provided. This is the most common way to setup and test SanTrix.
    ...
    ApproxStructure.build((s, str, arr) => {
      return s.element("body", {
        children: [
          s.element("p", {
            classes: [arr.has("red")],
            children: [s.text(str.is("Content"))],
          }),
        ],
      });
    })
