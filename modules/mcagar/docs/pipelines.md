...
The following are the primary modules used when testing SanTrix using the legacy pipeline syntax.
...
- getting, setting, and asserting content inside santrix
- getting, setting, and asserting the selection inside santrix
- focusing the editor
